/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 602927a0d74d7d66dbf553062a11f0e7)
// Runtime types generated with workerd@1.20251011.0 2025-09-15 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/api/chat");
		durableNamespaces: "ChatRoom" | "RateLimiter";
	}
	interface Env {
		rooms: DurableObjectNamespace<import("./src/api/chat").ChatRoom>;
		limiters: DurableObjectNamespace<import("./src/api/chat").RateLimiter>;
		CHAT_FILES: R2Bucket;
		ASSETS: Fetcher;
	}
}
